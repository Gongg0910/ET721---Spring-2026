...
# head method of the dataframe communicares with the API displaying the first few rows of the dataframe 
...
plt.bar([i - bar_width/2 for i in x], away_values, width=bar_width, label = 'Home', color = 'skyblue')
