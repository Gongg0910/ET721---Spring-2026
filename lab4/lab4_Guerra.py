...
print("\n----- Example 3: item(), key(), values() methods in a dictionary -----")
# item method return the key-value pairs in the dictionary
...
# values method return all the value in the dictionary
...
# get method returns the key-value pair of key
